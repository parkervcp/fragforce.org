...
@sched.scheduled_job('interval', minutes=app.config['CRON_TEAM_REFRESH_MINUTES'])
def _update_team():
...
@sched.scheduled_job('interval', minutes=app.config['CRON_PARTICIPANTS_REFRESH_MINUTES'])
