...
SINGAPORE_DONATIONS = int(os.environ.get('SINGAPORE_DONATIONS', '0.0'))
CHILDSPLAY_DONATIONS = int(os.environ.get('CHILDSPLAY_DONATIONS', '0.0'))
TARGET_DONATIONS = int(os.environ.get('TARGET_DONATIONS', '1.0'))
